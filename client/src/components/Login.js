...
import {tryLogin, handleUserChanged, checkSession} from "../actions"
...
class Login extends Component {
    ...
    render() {
        return !this.props.isUserAuthenticated ? <Grid textAlign='center' style={{ height: '100vh' }} verticalAlign='middle'>
