 ...
 */
@Provider
public class AuthenticationFilterDeprecated implements ContainerRequestFilter {
    private final int LOGIN_DURATION = 30; //Minutes.

    private static final Logger LOGGER  =  Logger.getLogger(AuthenticationFilterDeprecated.class.getName());
